...
<head>
  ...
  <script>
	  $(document).ready(function(){
			...
			//채팅 서버 주소
		  let url = "ws://192.168.50.91:9090/javaweb12S/chatserver";
...
<br/>
<div class="container">
	<h2 class="page-header">실시간 상담<font size="3" color="blue">(<span id="chatStatus">${sNickName}님 <font color="red">접속대기</font>상태</span>)</font></h2>		
	...
	<div style="height:400px;border:1px solid #fff;border-radius:4px;margin:2px 0;background-color:#eee;">
		<div id="list"></div>
	</div>
	<div>
		<div>
