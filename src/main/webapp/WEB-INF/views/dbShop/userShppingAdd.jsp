...
<div class="container">
  ...
  <table class="table table-borderless text-center" style="margin: 0 auto; width:500px">
    <tr class="table-dark text-dark">
      <th colspan="2">배송지 등록</th>
    </tr>
    <tr>
		  <th width="20%" class="text-center">배송지명</th>
		  <td><input type="text" name="shippingName" id="shippingName" class="form-control"/></td>
		</tr>
    <tr>
      ...
      <div class="input-group mb-1">
		...
		<tr>
			<td colspan="2">
				...
				<input type="button" value="배송지 등록" onclick="listAdd()" class="btn btn-outline-dark form-control mb-2">
