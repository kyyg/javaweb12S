...
<div class="container">
<h3 class="text-center pt-5 pb-5">주문/결제(장바구니에서 결제)</h3>
	<form name="myform" method="post" action="${ctp}/dbShop/dbOrderInputOk">
		...
		<c:set var="productName" value="${fn:split(orderVO.productName,',')}" />
		...
		<div><input type="submit" class="form-control mb-5" value="${totalPrice}원 결제하기" onclick="order()" style="background-color:#eee"/></div>
	</form>
</div>
