...
<div class="container">
  ...
  <table class="table table-bordered">
    ...
    <tr>
 	...
 	<div class="text-right mb-5"><input type="button" value="돌아가기" onclick="location.href='${ctp}/board/boardList?pag=${pag}&pageSize=${pageSize}';" class="btn btn-outline-dark btn-sm"/></div>
